...
% the co-ordinates --half step (6 inchs)
	%bottom
...
% the co-ordinates --third step
	%bottom
\foreach \x in {0,0.33333333333,...,4} {
\draw [thin] (\x,0) -- (\x,-0.125);
}
	%top
\foreach \x in {0,.33333333333,...,4} {
\draw [thin] (\x,8) -- (\x,8.125);
}
	%left
\foreach \y in {0,.33333333333,...,8} {
...
% the co-ordinates --6th step
	%bottom
\foreach \x in {0,.16666666666,...,4} {
\draw [thin] (\x,0) -- (\x,-0.1);
}
	%top
\foreach \x in {0,.16666666666,...,4} {
...
% the co-ordinates --12th step
	%bottom
\foreach \x in {0,.08333333333,...,4} {
...
%For inch style seperation 1/16th
